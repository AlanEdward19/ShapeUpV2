...
- **Feature**: exercise-variations (Fase 3.5, backend half) — **CLOSED / Verified PASS** (2026-09-17)
...
- **Next step**: `ShapeUp-Web` implements UI/offline halves; then remaining Fase 3.5 API feature `time-based-exercises`
- **Blockers**: none
