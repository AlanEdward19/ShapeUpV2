...
public sealed class IntegrationWebApplicationFactory(SqlServerFixture fixture) : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            // HTTP, so this override was never needed until WorkoutTemplates/Workouts tests started
            // hitting a real professional-client relationship lookup — without it, the app fell back to
            // whatever connection string ApplyMigrationsOnStartup/appsettings has for DefaultConnection,
            // which doesn't point at the test container.
